...
const ErrorBanner: React.FC<ErrorBannerProps> = ({ message, onDismiss }) => {
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-red-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      ...
      >
        <div
          className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-[#ff8080] to-[#fc9090] opacity-30"
          style={{
            clipPath:
      ...
      {onDismiss && (
        <div className="flex flex-1 justify-end">
          ...
          >
            ...
            <svg className="h-5 w-5 text-red-900" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
